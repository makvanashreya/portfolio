    ...
    <div name="Portfolio" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 text-white' >
        <div className=' max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-screen text-white '>
          ...
          <div className=' mb-20'>
            ...
            <p className=' py-6'>These are the some of my work</p>
          </div>
      ...
      <div className=''>
      {
        ...
        <div className=' w-full lg:w-1/4'>
          <img src={src} 
               ...
               width={150} 
               alt="" 
               className=' mb-6 rounded hover:scale-105 duration-500' />
        </div> 
        ...
        <div className=' w-full max-w-xl lg:w-3/4'>
            ...
            {tecnology.map((tech,index) => (
                <span key={index} 
                      className=' mr-2 rounded bg-neutral-800 text-sm font-medium' >{tech}</span>
            ))}
        </div>
        </div>
